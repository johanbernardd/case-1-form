...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse text-black" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link text-black" href="./view/login.php">LOGIN</a></li>
                    <li class="nav-item"><a class="nav-link text-black" href="./controller/logoutController.php">LOGOUT</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <main>
        <section class="hero text-center py-5" id="hero">
            <div class="container">
                <img src="https://seeklogo.com/images/K/kemenkes-logo-A1B9A09FBB-seeklogo.com.png"
                    alt="Klinik Pweb Logo" class="hero-logo mb-3">
                <h1>KLINIK SEHAT</h1>
        ...
        <section class="check-doctors text-center py-5" id="check-doctors">
            <div class="container">
                <h2>CEK DAFTAR DOKTER</h2>
                <a href="#" class="btn mt-3 bg-primary text-white">CEK DISINI</a>
            </div>
        </section>
            ...
            <div class="container text-center">
                ...
                <div class="d-flex flex-wrap justify-content-center">
                    <div class="team-member mx-2 my-2">
                        <img src="./resource/Achmad_Firdaus_Attalea_Yessa.jpeg" alt="Achmad Firdaus Attalea" class="rounded-circle mb-2">
                        <h3>Achmad Firdaus Attalea Yessa</h3>
                        <p>225150407111086</p>
                    </div>
                    <div class="team-member mx-2 my-2">
                        <img src="./resource/Dicky_Surya_Darmawan.jpg" alt="Dicky Surya Darmawan" class="rounded-circle mb-2">
                        <h3>Dicky Surya Darmawan</h3>
                        <p>225150407111063</p>
                    </div>
                    <div class="team-member mx-2 my-2">
                        <img src="./resource/Johanes_Paulus_Bernard_Purek.png" alt="Johanes Paulus Bernard Purek" class="rounded-circle mb-2">
                        <h3>Johanes Paulus Bernard Purek</h3>
                        <p>225150407111090</p>
                    </div>
                    <div class="team-member mx-2 my-2">
                        <img src="./resource/Muhammad_Choliq_Alraf.jpg" alt="Muhammad Choliq Al-Raffi" class="rounded-circle mb-2">
                        <h3>Muhammad Choliq Al-Raffi</h3>
                        <p>225150407111065</p>
                    </div>
                    <div class="team-member mx-2 my-2">
                        <img src="./resource/Syafiq.jpg" alt="Muhammad Syafiq Irzaky" class="rounded-circle mb-2">
