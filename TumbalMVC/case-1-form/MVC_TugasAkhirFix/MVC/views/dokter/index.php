...
<body>
    <div class="container">
        <div class="button-container">
            ...
            <a href="router.php?controller=jadwal&action=index">Next➡️</a>
        </div>
        <h1>Daftar Dokter</h1>
                ...
                foreach ($dokters as $key => $dokter): ?>
                    <tr>
                        ...
                        <td class="action-links">
                            <a href="../../router.php?controller=dokter&action=edit&id=<?php echo $dokter['id']; $_GET['id'] = $dokter['id']?>"> Edit</a>
                            <a href="../../router.php?controller=dokter&action=delete&id=<?php echo $dokter['id']; ?>"
                                onclick="return confirm('Anda yakin ingin menghapus obat ini?')">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
