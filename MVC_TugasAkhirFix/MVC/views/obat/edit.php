...
<body>
    <form action="index.php?c=ObatController&m=edit&id=<?php echo $obatData['id']; ?>" method="POST">
        <h1>Edit Obat</h1>
        <label for="nama">Nama:</label>
        <input type="text" name="nama" id="nama" class="form-control" value="<?php echo $obatData['nama']; ?>" required>
        <label for="harga">Harga:</label>
        <input type="number" name="harga" id="harga" class="form-control" value="<?php echo $obatData['harga']; ?>" required>
