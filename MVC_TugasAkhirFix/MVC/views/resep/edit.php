...
<body>
    <h1>Edit Resep</h1>
    <form action="index.php?c=ResepController&m=edit&id=<?php echo $resepData['id']; ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama_obat" class="form-control" id="nama_obat" value="<?php echo $resepData['nama_obat']; ?>" required>
        </div>
        <div class="form-group">
            <label for="tanggal">Tanggal</label>
            <input type="date" name="tanggal" class="form-control" id="tanggal" value="<?php echo $resepData['tanggal']; ?>" required>
        </div>
        <div class="form-group">
            <label for="jumlah">Jumlah</label>
            <input type="number" name="jumlah" class="form-control" id="jumlah" value="<?php echo $resepData['jumlah']; ?>" required>
        </div>
