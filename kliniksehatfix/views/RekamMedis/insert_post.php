            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    ...
                    <ul id="dropdown-rekam-medis" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="index.php?c=RekamMedisController&m=create_process" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 text-teal-600 hover:text-teal-500 mr-4" 
                            style="color: #008080; text-decoration: none;" onmouseover="this.style.color='#004c4c'" onmouseout="this.style.color='#008080'">
