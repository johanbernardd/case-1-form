        ...
        <div class="relative m-4 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-center text-gray-500 dark:text-gray-400">
                <caption style="caption-side: top;" class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    DOKTER
                    <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Daftar Dokter yang Bekerja Sama dengan Klinik Kami.</p>
                </caption>
                ...
                <tbody class="text-center">
                    <?php foreach ($dokters as $dokter) : ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-900">
                            <td class="px-6 py-4" style="color: black;"><?php echo $dokter['id']; ?></td>
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <?php echo $dokter['nama']; ?>
                            </td>
                            <td class="px-6 py-4" style="color: black;"><?php echo $dokter['spesialisasi']; ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo $dokter['telepon']; ?></td>
                            <td class="px-6 py-4" style="align: center; width: 20%; height: 20%; object-fit: cover;"><img src="data:image/jpeg;base64,<?php echo base64_encode($dokter['gambar']); ?>" alt="Dokter Gambar" class="profil-dokter" ></td>
                            <td class="px-6 py-4">
                                <a href="?c=DokterController&m=edit&id=<?php echo $dokter['id']; ?>" 
                                ...
                                <a href="?c=DokterController&m=delete&id=<?php echo $dokter['id']; ?>" 
                                    ...
                                    onclick="return confirm('Anda yakin ingin menghapus dokter ini?')" 
                                    style="text-decoration: none;">
                                    Delete
                                </a>
                            </td>
