        ...
        <div class="relative m-4 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-center text-gray-500 dark:text-gray-400">
                <caption style="caption-side: top;" class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    RESEP
                    <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Daftar Resep yang Telah Dibuat.</p>
                </caption>
                ...
                <tbody class="text-center">
                    <?php foreach ($reseps as $key => $resep) : ?>
                        <tr>
                            ...
                            <td class="px-6 py-4" style="color: black;"><?php echo $resep['nama_obat']; ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo $resep['tanggal']; ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo $resep['jumlah']; ?></td>
                            <td class="px-6 py-4">
                                <a href="?c=ResepController&m=edit&id=<?php echo $resep['id']; ?>"
                                    class="text-teal-600 hover:text-teal-500 mr-4"
                                    style="text-decoration: none;">
                                    Edit
                                </a>
                                <a href="?c=ResepController&m=delete&id=<?php echo $resep['id']; ?>"
