            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    ...
                    <ul id="dropdown-rekam-medis" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="index.php?c=RekamMedisController&m=create_form" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 text-teal-600 hover:text-teal-500 mr-4" 
                            style="color: #008080; text-decoration: none;" onmouseover="this.style.color='#004c4c'" onmouseout="this.style.color='#008080'">
                ...
                <li>
                    ...
                    <ul id="dropdown-pembayaran" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="index.php?c=PembayaranController&m=create_form" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 text-teal-600 hover:text-teal-500 mr-4" 
                            style="color: #008080; text-decoration: none;" onmouseover="this.style.color='#004c4c'" onmouseout="this.style.color='#008080'">
                                Tambah Pembayaran</a>
                        </li>
                    </ul>
    ...
    <div class="sm:ml-64" style="padding-top: 5rem">
        <div class="relative m-4 overflow-x-auto shadow-md sm:rounded-lg">
            <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form class="space-y-6" action="index.php?c=PasienController&m=edit&id=<?php echo $patientData['id']; ?>" method="POST">
                    <h5 class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white" style="text-align:center">Edit Pasien</h5>
                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama</label>
                        <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="<?php echo $patientData['nama']; ?>" required>
                    </div>
                    <div>
                        <label for="dob" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal Lahir</label>
                        <input type="date" name="dob" id="dob" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="<?php echo $patientData['dob']; ?>" required>
                    </div>
                    <div>
                        <label for="gender" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis Kelamin</label>
                        <select name="gender" id="gender" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                            <option value="Male" <?php echo $patientData['gender'] == 'Male' ? 'selected' : ''; ?>>Laki-laki</option>
                            <option value="Female" <?php echo $patientData['gender'] == 'Female' ? 'selected' : ''; ?>>Perempuan</option>
                        </select>
                    </div>
                    <div>
                        <label for="address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat</label>
                        <input type="text" name="address" id="address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="<?php echo $patientData['address']; ?>" required>
                    </div>
