        ...
        <div class="relative m-4 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-center text-gray-500 dark:text-gray-400">
                <caption style="caption-side: top;" class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    PASIEN
                    <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Daftar Pasien yang Terdaftar di Klinik Kami.</p>
                </caption>
                ...
                <tbody class="text-center">
                    <?php foreach ($result as $key => $patient) : ?>
                        <tr>
                            <td class="px-6 py-4" style="color: black;"><?php echo $key + 1; ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo $patient['nama']; ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo date('d-m-Y', strtotime($patient['dob'])); ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo $patient['gender']; ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo $patient['address']; ?></td>
                            <td class="px-6 py-4">
                                <a href="index.php?c=PasienController&m=edit&id=<?php echo $patient['id']; ?>"
                                    class="text-teal-600 hover:text-teal-500 mr-4"
                                    style="text-decoration: none;">
                                    Edit
                                </a>
                                <a href="index.php?c=PasienController&m=delete&id=<?php echo $patient['id']; ?>"
