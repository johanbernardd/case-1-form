    ...
    <div class="sm:ml-64" style="padding-top: 5rem">
        <div class="relative m-4 overflow-x-auto shadow-md sm:rounded-lg">
            <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form class="space-y-6" action="?c=PembayaranController&m=update" method="POST">
                    <h5 class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white" style="text-align:center">Edit Pembayaran</h5>    
                    <input type="hidden" name="id" value="<?php echo htmlspecialchars($pembayaran['id']); ?>">
                    <div>
                        <label for="rekam_medis_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rekam Medis ID</label>
                        <select name="rekam_medis_id" id="rekam_medis_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah_bayar" id="jumlah_bayar" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="<?php echo htmlspecialchars($pembayaran['jumlah_bayar']); ?>">
                    </div>
                    <div>
                        <label for="metode_pembayaran" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Metode Pembayaran</label>
                        <input type="text" name="metode_pembayaran" id="metode_pembayaran" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="<?php echo htmlspecialchars($pembayaran['metode_pembayaran']); ?> " placeholder="Cash/Debit/Kredit">
                    </div>
