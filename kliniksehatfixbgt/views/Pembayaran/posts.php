        ...
        <div class="relative m-4 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-center text-gray-500 dark:text-gray-400">
                <caption style="caption-side: top;" class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    PEMBAYARAN
                    <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Daftar Pasien yang Melakukan Pembayaran di Klinik Kami.</p>
                </caption>
                ...
                <tbody class="text-center">
                    <?php foreach ($pembayaran as $p) : ?>
                        <tr>
                            <td class="px-6 py-4" style="color: black;"><?php echo htmlspecialchars($p['id']); ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo htmlspecialchars($p['rekam_medis_id']); ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo htmlspecialchars($p['jumlah_bayar']); ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo htmlspecialchars($p['metode_pembayaran']); ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo htmlspecialchars($p['created_at']); ?></td>
                            <td class="px-6 py-4">
                                <a href="?c=PembayaranController&m=edit&id=<?php echo htmlspecialchars($p['id']); ?>"
                                    class="text-teal-600 hover:text-teal-500 mr-4"
                                    style="text-decoration: none;">
                                    Edit
                                </a>
                                <a href="?c=PembayaranController&m=delete&id=<?php echo htmlspecialchars($p['id']); ?>"
                                    class="text-teal-600 hover:text-teal-500"
                                    onclick="return confirm('Anda yakin ingin menghapus resep ini?')" 
                                    style="text-decoration: none;">
                                    Delete
                                </a>
                            </td>
