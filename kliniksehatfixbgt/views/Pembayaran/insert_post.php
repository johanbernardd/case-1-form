...
<body>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    ...
                    <ul id="dropdown-pembayaran" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="index.php?c=PembayaranController&m=create_form" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 text-teal-600 hover:text-teal-500 mr-4te
                            style="color: #008080; text-decoration: none;" onmouseover="this.style.color='#004c4c'" onmouseout="this.style.color='#008080'">
                                Tambah Pembayaran</a>
                        </li>
                    </ul>
    ...
    <div class="sm:ml-64" style="padding-top: 5rem">
        <div class="relative m-4 overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <form class="space-y-6" action="index.php?c=PembayaranController&m=create_process" method="POST">
                <h5 class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white" style="text-align:center">Tambah Pembayaran</h5>    
                    <div class="mb-3">
