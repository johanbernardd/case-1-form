        ...
        <div class="relative m-4 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-center text-gray-500 dark:text-gray-400">
                <caption style="caption-side: top;" class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    REKAM MEDIS
                    <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Daftar Rekam Medis Pasien yang Ada di Klinik Kami.</p>
                </caption>
                ...
                <tbody class="text-center">
                    <?php if (isset($rekamMedis) && count($rekamMedis) > 0) : ?>
                        <?php foreach ($rekamMedis as $rekam_medis) : ?>
                            <tr>
                                <td class="px-6 py-4" style="color: black;"><?php echo htmlspecialchars($rekam_medis['id']); ?></td>
                                <td class="px-6 py-4" style="color: black;"><?php echo htmlspecialchars($rekam_medis['pasien_nama']); ?></td>
                                <td class="px-6 py-4" style="color: black;"><?php echo htmlspecialchars($rekam_medis['dokter_nama']); ?></td>
                                <td class="px-6 py-4" style="color: black;"><?php echo htmlspecialchars($rekam_medis['tanggal']); ?></td>
                                <td class="px-6 py-4" style="color: black;"><?php echo htmlspecialchars($rekam_medis['diagnosa']); ?></td>
                                <td class="px-6 py-4" style="color: black;"><?php echo htmlspecialchars($rekam_medis['tindakan']); ?></td>
                                <td class="px-6 py-4">
                                    <a href="index.php?c=RekamMedisController&m=edit&id=<?php echo htmlspecialchars($rekam_medis['id']); ?>"
                                        class="text-teal-600 hover:text-teal-500 mr-4"
                                        style="text-decoration: none;">
                                        Edit
                                    </a>
                                    <a href="index.php?c=RekamMedisController&m=delete&id=<?php echo htmlspecialchars($rekam_medis['id']);?>"
                                        class="text-teal-600 hover:text-teal-500"
                                        onclick="return confirm('Anda yakin ingin menghapus rekam medis ini?')" 
                                        style="text-decoration: none;">
                                        Delete
                                    </a>
                                </td>
