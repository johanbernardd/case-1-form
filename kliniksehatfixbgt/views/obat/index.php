        ...
        <div class="relative m-4 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-center text-gray-500 dark:text-gray-400">
                <caption style="caption-side: top;" class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    OBAT
                    <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Daftar Obat yang Tersedia di Klinik Kami.</p>
                </caption>
                ...
                <tbody class="text-center">
                    <?php foreach ($obats as $key => $obat) : ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-900">
                            ...
                            <td class="px-6 py-4" style="color: black;"><?php echo 'Rp ' . number_format($obat['harga'], 0, ',', '.'); ?></td>
                            <td class="px-6 py-4">
                                <a href="?c=ObatController&m=edit&id=<?php echo $obat['id']; ?>" 
                                    class="text-teal-600 hover:text-teal-500 mr-4"
                                    style="text-decoration: none;">
                                    Edit
                                </a>
                                <a href="?c=ObatController&m=delete&id=<?php echo $obat['id']; ?>" 
